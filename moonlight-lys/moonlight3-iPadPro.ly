...
topmain =  \relative c'
{
	...
	\tuplet 3/2 { \once \override Slur.control-points = #'((1.5 . 3.75) (7 . 5) (14 . 5) (19.4 . 1.5))  a8-5-(-\f fis cis } \clearTuplet \tuplet 3/2 { a \moveFingering #'(0 . 0) fis_4 cis-) \slurUp 
	...
	\tuplet 3/2 { \once \override Slur.control-points = #'((1.5 . 3.75) (7 . 5) (14 . 5) (20.6 . 1.5)) a'8-(-\f fis d a fis d-4-) 
	...
	\tuplet 3/2 { \once \override Slur.control-points = #'((1.5 . 4.75) (6 . 5.5) (14 . 4) (19.2 . 2)) \moveFingering #'(0 . 0.5) cis'8-4-(-\f ais fisis e \moveFingering #'(0 . -1) cis-3 \moveFingering #'(0 . -2) ais-2-) \moveFingering #'(0 . 0.5) e'-5-( cis ais } fisis16 e_1 cis_3 ais_2-) |
	...
	\stemUp
	\change Staff = "down"
	ais fisis \moveFingering #'(0 . 2) e_1 \moveFingering #'(0 . 1) cis_2 \moveFingering #'(0 . 2) e_1 fisis \once \override TupletNumber.extra-offset = #'(0 . 11) \tuplet 6/4 { ais-[
		\stemDown
		\change Staff = "up"
	cis \moveFingering #'(0 . -3.5) e-1 fisis ais cis-] e-1-[ fisis ais cis ais e-]-) } |
	\clearTuplet \tuplet 3/2 { \once \override Slur.control-points = #'((2 . 5.5) (30 . 11) (80 . 4) (97.5 . -7.5)) e'8-( \moveFingering #'(0 . 1.5) cis-4 gis } \tuplet 3/2 { e \moveFingering #'(0 . -1) cis-4 gis e' cis gis } \stemUp e16 \moveFingering #'(0 . 2) cis'_4 gis e | \revertTuplet
	cis_2 gis'_5 e cis
	\stemUp
	\change Staff = "down"
	...
	\change Staff = "up"
	bis16 cis cisis dis
	\tuplet 5/4 { e16-( eis fis fisis gis-) }
	\tuplet 5/4 { a16-[-( ais b! bis cis-]-) }
	\tuplet 3/2 { d16-[-( dis e-]-) }
	eis32 (fis fisis gis-)\) |
